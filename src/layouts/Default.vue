      ...
      >
        ...
        <ul class="flex items-center space-x-8">
          ...
          <li>
            <a
              aria-label="Linkedin"
              href="https://www.linkedin.com/in/kdorsel/"
              target="_blank"
              rel="noopener"
              class="text-white hover:text-gray-400"
            >
          ...
          <li>
            ...
            >
              <svg fill="currentColor" width="19" height="22">
                <path d="M16 20v-6h2v8H0v-8h2v6h14z"></path>
                <path
                  d="M12.72 0l-1.57 1.17L17 9.05l1.57-1.18L12.72 0zM4 18h10v-2H4v2zm11.4-7.08L7.86 4.64l1.25-1.5 7.54 6.28-1.25 1.5zm-10-1.91l8.9 4.14.82-1.78-8.9-4.14L5.4 9zm8.63 6.27l-9.9-1.67.4-1.92 9.63 1.92-.13 1.67z"
                ></path>
              </svg>
            </a>
          </li>
...
export default {
  ...
  mounted() {
    ...
    amplitude.getInstance().init("5c572f098c8e722bc366e47bd6b778b4");
  },
  methods: {
    toggle() {
