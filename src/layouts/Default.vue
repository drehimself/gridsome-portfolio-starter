<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-indigo-500">
    ...
    <footer class="bg-indigo-500 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div>&copy; {{ new Date().getFullYear() }} - Web Matters</div>
          <div>
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:andrew.smith@webmatters.io" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/webmatters/wm-site" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/thewebmatters" target="_blank" class="text-white hover:text-gray-400">
